...
const index$1 = "";
const card = "_card_lkhz6_1";
const cardInfo = "_cardInfo_lkhz6_25";
const selected = "_selected_lkhz6_33";
const verticalAlign = "_verticalAlign_lkhz6_41";
const generateButton = "_generateButton_lkhz6_51";
const classes = {
  card,
  cardInfo,
  selected,
...
function Card(props) {
  const [generatedName, setGeneratedName] = reactExports.useState("");
  const [generatedNumber, setGeneratedNumber] = reactExports.useState("");
  ...
  function generateName() {
    const generateName2 = `Player ${props.id}`;
    setGeneratedName(generateName2);
    props.setCardName(generateName2);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${classes.card} ${props.selected && classes.selected}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.verticalAlign, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      props.id,
      "."
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.cardInfo, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Card Number:" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.cardInfo, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "Generate Card Name"
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.verticalAlign, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: props.selected, onClick: switchToCard, children: "Switch" }) })
  ] });
}
const App$1 = "";
function App() {
  const [cards, setCards] = reactExports.useState([]);
  const [importError, setImportError] = reactExports.useState(false);
  const [aimePath, setAimePath] = reactExports.useState("");
  const [, updateState] = reactExports.useState();
  const forceUpdate = reactExports.useCallback(() => updateState({}), []);
  ...
  const cardsList = cards.map((card2, index2) => {
    function setCardNumber(cardNumber) {
      card2.cardNumber = cardNumber;
      console.log(cards);
      window.localStorage.setItem("Cards", JSON.stringify(cards));
    }
    function setCardName(cardName) {
      card2.cardName = cardName;
      console.log(cards);
      window.localStorage.setItem("Cards", JSON.stringify(cards));
    }
    function clearSelected2() {
      cards.forEach((card22) => {
        card22.selected = false;
      });
      card2.selected = true;
      window.localStorage.setItem("Cards", JSON.stringify(cards));
      forceUpdate();
    ...
    function writeAime() {
      ...
      const data = card2.cardNumber.toString();
  ...
  async function changeDir(event) {
    ...
    reader.onload = async function() {
      if (this.result !== "" && this.result.length === 20) {
        ...
        console.log(cards);
        clearSelected();
        await cards.forEach((card2) => {
          if (card2.cardNumber === this.result.toString()) {
            console.log(card2.cardNumber, this.result, "???");
            shouldImport = false;
            card2.selected = true;
          }
        });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "root", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Chuni Switch" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "label",
        {
          htmlFor: "",
          style: { color: "red" },
          className: aimePath !== "" && !importError ? "hidden" : void 0,
          children: !importError ? "Please import your current aime.txt file" : "File does not meet aime number requirements"
        }
      ),
      aimePath !== "" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: aimePath }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "file-upload", className: "custom-file-upload", children: "Change Directory" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "file-upload", type: "file", onChange: changeDir })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cardsList", children: cardsList }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: addCard,
          style: { marginTop: "1rem" },
          className: aimePath === "" ? "hidden" : void 0,
          children: "Add Card"
        }
      ) })
    ] })
